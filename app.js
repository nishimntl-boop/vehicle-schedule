...
function WTXT(e,d){if(e.kind==='off')return '休み';const night=nightOnDay(e,d);return (e.kind==='plan'?'予定 ':'')+(night?'🌙 ':'')+(e.site||'未設定')+' '+e.start+'-'+e.end;}
